  ...
  return (
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
      <div className="container flex flex-wrap  items-center mx-auto">
        ...
        <div
          className="hidden w-full md:block md:w-auto md:mx-auto"
          id="mobile-menu"
        >
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-6 md:text-sm md:font-medium mx-auto">
            <li>
              <CustomLink
                to="/home"
