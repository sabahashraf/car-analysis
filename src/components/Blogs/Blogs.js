  ...
  return (
    <div>
      <section className="px-6 pt-20 pb-24 mx-auto max-w-7xl md:px-2 w-3/4">
        <h3 className="text-xl font-medium mb-4">What is Context api? </h3>
        ...
        <p className="leading-7">
          <p className="mb-2">
            <span className="font-semibold">Inline elements:</span>Inline
            elements are those who displays its content inline or on the same
            line.Inline elements do not start ona new line.width and height
            properties haas no effect onthem. span,a,img,em,strong,i,small are
            some inline elements.
          </p>
          <p className="mb-2">
            <span className="font-semibold">Inline-block elements:</span>The
            only difference between inline and inline-block elements are we can
            set width and height properties on them.
          </p>
          <p className="mb-2">
            <span className="font-semibold">Block elements:</span>Block elements
            starts on a new line and takes up the whole width.It means block
            elements occupy the whole width of its parent element.
